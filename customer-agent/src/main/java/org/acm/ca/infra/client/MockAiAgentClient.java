...
/**
 * In-memory mock of {@link AiAgentClient} for LLM-less demos and failure injection. Active only
 * with {@code customer.adapters.ai-agent=mock}; the real in-process adapter is the default.
 */
@Component
@ConditionalOnProperty(name = "customer.adapters.ai-agent", havingValue = "mock")
