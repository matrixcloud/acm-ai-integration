...
/**
 * Knowledge-base retrieval tool exposed to the ReAct loop. Tool failures are converted to an
 * error message for the LLM to reason about, rather than propagated as exceptions.
 */
@Component
