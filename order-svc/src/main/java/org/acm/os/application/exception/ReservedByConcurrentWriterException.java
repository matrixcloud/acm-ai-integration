 ...
 *
 * <p>The caller should abort execution; the concurrent writer's result will be available for
 * replay once it completes. Maps to HTTP 409 Conflict via {@code GlobalExceptionHandler} (code
