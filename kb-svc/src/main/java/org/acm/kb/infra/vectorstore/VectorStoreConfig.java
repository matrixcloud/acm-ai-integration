 ...
 * distance, 1024 dimensions, {@code initialize-schema=true}). This class also provides the
 * {@link RecursiveCharacterTextSplitter} bean with default settings.
 */
@Configuration
public class VectorStoreConfig {

  /**
   * Provides a {@link RecursiveCharacterTextSplitter} with default chunk size 1000 and overlap
   * 200.
   *
